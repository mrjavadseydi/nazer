...
{{--            <img alt="Logo" src="{{ url('assets/img/logo-light.png') }}" />--}}
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                @foreach(\Illuminate\Support\Facades\Config::get('menu.primary-' . \Illuminate\Support\Facades\Auth::user()->role->name) as $menu)
{{--                    @if( $item['type'] !== 'group' )--}}
{{--                        @permission($item['permission'])--}}
                            <li class="menu-item text-right @isset($menu['children']) menu-item-submenu @endisset" aria-haspopup="true" @isset($menu['children']) aria-haspopup="true" data-menu-toggle="hover" @endisset>
                                <a href="{{ isset($menu['children']) ? 'javascript:;' : $menu['url'] }}" class="menu-link @isset($menu['children']) menu-toggle @endisset">
...
{{--                            <h4 class="menu-text text-right">{{ $item['title'] }}</h4>--}}
{{--                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>--}}
{{--                        </li>--}}

{{--                                @permission($menu_item['permission'])--}}
{{--                                    <li class="menu-item text-right menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">--}}
{{--                                        <a href="{{ isset($menu['children']) ? 'javascript:;' : $menu['url'] }}" class="menu-link menu-toggle">--}}
...
{{--                                                                <a href="{{ $child['url'] }}" class="menu-link menu-toggle">--}}
{{--                                                                    <i class="menu-bullet menu-bullet-line">--}}
{{--                                                                        <span></span>--}}
{{--                                                                    </i>--}}
{{--                                                                    <span class="menu-text">{{ $child['title'] }}</span>--}}

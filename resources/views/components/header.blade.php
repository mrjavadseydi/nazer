...
{{--                        <p class="bg-purple-400">{{ \Illuminate\Support\Str::substr($user->fullName, 0, 1) }}</p>--}}
                        <p style="font-size: 18px">کاربر فعلی: <strong>{{ $user->fullName }}</strong></p>
                    </li>
{{--                    @foreach( \Illuminate\Support\Facades\Config::get('dashboard.secondary') as $menu)--}}
{{--                    <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">--}}
{{--                        <a href="javascript:;" class="menu-link menu-toggle">--}}
{{--                            <span class="menu-text">{{ strtolower($menu['title']) }}</span>--}}
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <div>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{ url('assets/img/bg-1.jpg') }})">
                            <!--begin::Title-->
                            <h4 class="d-flex flex-center rounded-top">
                                <span class="text-white">اعلان های کاربر</span>
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md mr-2">مورد جدید: 23</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                            <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">هشدار ها</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">اخطار ها</a>
                                </li>
                            </ul>
                            <!--end::Tabs-->
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                ...
                                <div class="d-flex flex-center pt-7">
                                    <a href="#" class="btn btn-light-primary font-weight-bold text-center">مشاهده همه</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Tabpane-->
                            ...
                            <div class="tab-pane p-8" id="topbar_notifications_events" role="tabpanel">
                                ...
                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40 symbol-light-success @if(Lang::getLocale() == 'fa') ml-5 @else mr-5 @endif">
                                            <span class="symbol-label">

                ...
                <div class="row text-right">
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">کد ملی: <strong>{{ $plan->performer->nationalityCode }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">نام: <strong>{{ $plan->performer->firstName }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">نام خانوادگی: <strong>{{ $plan->performer->lastName }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">تاریخ تولد: <strong>{{ $plan->performer->birthday }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">تلفن: <strong>{{ $plan->performer->phone }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">جنسیت: <strong>{{ $plan->performer->gender ? ($plan->performer->gender == 'male' ? 'مرد' : 'زن') : '-' }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">تحت پوشش کمیته امداد: <strong>{{ $plan->performer->under_support ? ($plan->performer->under_support == '1' ? 'بله' : 'خیر') : '-' }}</strong></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                            <label for="" class="form-label">محله: @if(!is_null($plan->areaCity))<strong>{{ $plan->areaCity->area->title }}</strong>@endif</label>
                        </div>
                    </div>
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <div class="row text-right border-bottom border-bottom-light-light mb-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row align-items-start">
                                    <div class="form-group col-lg-4">
                                        <input type="text" class="form-control" id="latitude" name="latitude" value="{{ $plan->latitude }}">
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <input type="text" class="form-control" id="longitude" name="longitude" value="{{ $plan->longitude }}">
                                    </div>
                                    <div class="col-lg-4">
                                        <button class="btn btn-primary" type="button" onclick="getLocation()">دریافت لوکیشن</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="" class="form-label"><strong>فاصله اداره تا موقعیت طرح (برحسب کیلومتر)</strong></label>
                                <div class="d-flex">
                                    <input type="text" class="form-control" id="distance" name="distance" value="{{ $plan->distance }}">
                                    <button class="btn btn-primary mr-4" type="button" id="calcDistance" onclick="calculateDistance(this)" data-p1-lat="{{ $plan->latitude }}" data-p1-lng="{{ $plan->longitude }}" data-p2-lat="{{ $plan->organization->latitude }}" data-p2-lng="{{ $plan->organization->longitude }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="need_course" value="yes" @if( $plan->performer->need_course ) checked @endif data-need-courses/>
                                        <span class="mr-0 ml-2"></span>
                                        دارد
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="need_course" value="no" @if( !$plan->performer->need_course ) checked @endif data-need-courses/>
                                        <span class="mr-0 ml-2"></span>
                                        ندارد
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6" @if( !$plan->performer->need_course ) style="display: none" @endif data-courses>
                            <div class="form-group">
                                <label for="" class="form-label"><strong>مشخص کردن دوره ها</strong></label>
                                <select name="courses[]" class="custom-select form-control select2-generate" id="courses" multiple="multiple">
                        ...
                        <div class="col-lg-4 col-sm-6" style="display: none" data-suggest-course>
                            <div class="form-group">
                                ...
                                <select name="suggests[]" class="custom-select form-control select2-generate" id="suggests" multiple="multiple">
                    ...
                    <div class="row text-right border-bottom border-bottom-light-light mb-8">
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="is_special" value="yes" @if( $plan->is_special ) checked @endif data-is-special/>
                                        <span class="mr-0 ml-2"></span>
                                        بله
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="is_special" value="no" @if( !$plan->is_special ) checked @endif data-is-special/>
                                        <span class="mr-0 ml-2"></span>
                                        خیر
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-8 col-sm-6" @if( !$plan->is_special ) style="display: none" @endif data-special-resaon>
                            <div class="form-group">
                                <label for="" class="form-label"><strong>دلیل و کار شاخص طرح</strong></label>
                                <textarea name="special_reason" rows="3" class="form-control">{{ $plan->special_reason }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row text-right border-bottom border-bottom-light-light mb-8">
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="is_exhibition" value="yes" @if( $plan->is_exhibition ) checked @endif data-is-exhibition/>
                                        <span class="mr-0 ml-2"></span>
                                        دارد
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="is_exhibition" value="no" @if( !$plan->is_exhibition ) checked @endif data-is-exhibition/>
                                        <span class="mr-0 ml-2"></span>
                                        ندارد
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6" @if( !$plan->is_exhibition ) style="display: none" @endif data-exhibition-level>
                            <div class="form-group">
                                <label for="" class="form-label"><strong>سطح نمایشگاهی</strong></label>
                                <div class="radio-inline">
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_level" value="شهرستانی" @if( $plan->exhibition_level == 'شهرستانی' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        شهرستانی
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_level" value="استانی" @if( $plan->exhibition_level == 'استانی' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        استانی
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_level" value="کشوری" @if( $plan->exhibition_level == 'کشوری' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        کشوری
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6" @if( !$plan->is_exhibition ) style="display: none" @endif data-exhibition-desire>
                            <div class="form-group">
                                <label for="" class="form-label"><strong>تمایل مجری</strong></label>
                                <div class="radio-inline">
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_desire" value="کم" @if( $plan->exhibition_desire == 'کم' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        کم
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_desire" value="متوسط" @if( $plan->exhibition_desire == 'متوسط' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        متوسط
                                    </label>
                                    <label class="radio radio-outline radio-primary mr-0 ml-4">
                                        <input type="radio" name="exhibition_desire" value="زیاد" @if( $plan->exhibition_desire == 'زیاد' ) checked @endif/>
                                        <span class="mr-0 ml-2"></span>
                                        زیاد
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                <input type="radio" name="has_employment" value="yes" @if( $plan->has_employment ) checked @endif data-has-employer/>
                                                <span class="mr-0 ml-2"></span>
                                                دارد
                                            </label>
                                            <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                <input type="radio" name="has_employment" value="no" @if( !$plan->has_employment ) checked @endif data-has-employer/>
                                                <span class="mr-0 ml-2"></span>
                                                ندارد
                                            </label>
                                        </div>
                            ...
                            <div class="row" @if( !$plan->has_employment ) style="display: none" @endif data-employers>
                                <div class="accordion accordion-toggle-arrow w-100 text-right" id="employers">
                                    @forelse($planEmployers as $employer)
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-title collapsed" data-toggle="collapse" data-target="#employers{{ $employer->id }}">
                                                    {{ $employer->fullName }}
                                                </div>
                                            </div>
                                            <div id="employers{{ $employer->id }}" class="collapse" data-parent="#employers">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-4 col-xs-5">
                                                        <div class="form-group">
                                                            <label for="nationalityCode"><strong>کد ملی</strong></label>
                                                            <input type="text" class="form-control" name="employers[{{ $employer->id }}][nationalityCode]" value="{{ $employer->nationalityCode }}" id="nationalityCode" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            <label for="fullName" class="form-label"><strong>نام خانوادگی</strong></label>
                                                            <input type="text" class="form-control" name="employers[{{ $employer->id }}][fullName]" value="{{ $employer->fullName }}" id="fullName" oninput="changeAccordionTitle(this)">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            <label for="supportStatus" class="form-label"><strong>وضعیت مددجویی</strong></label>
                                                            <select name="employers[{{ $employer->id }}][supportStatus]" id="supportStatus" class="form-control">
                                                                <option value="مددجو" @if( $employer->supportStatus == 'مددجو' ) selected @endif>مددجو</option>
                                                                <option value="غیر مددجو" @if( $employer->supportStatus == 'غیر مددجو' ) selected @endif>غیر مددجو</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="employers[{{ $employer->id }}][phone]" value="{{ $employer->phone }}" id="phone">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            <label for="employer_status" class="form-label"><strong>وضعیت شاغل در طرح</strong></label>
                                                            <input type="text" class="form-control" name="employers[{{ $employer->id }}][employer_status]" value="{{ $employer->employer_status }}" id="employer_status">
                                                            <select name="employers[{{ $employer->id }}][employer_status]" id="employer_status" class="form-control">
                                                                <option value="تمام وقت" @if( $employer->employer_status == 'تمام وقت' ) selected @endif>تمام وقت</option>
                                                                <option value="پاره وقت" @if( $employer->employer_status == 'پاره وقت' ) selected @endif>پاره وقت</option>
                                                                <option value="ساعتی" @if( $employer->employer_status == 'ساعتی' ) selected @endif>ساعتی</option>
                                                                <option value="موردی" @if( $employer->employer_status == 'موردی' ) selected @endif>موردی</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control persianDate" name="employers[{{ $employer->id }}][start_date]" value="{{ $employer->start_date }}" id="start_date">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="radio-inline" id="gender">
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][gender]" value="male" {{ $employer->gender == 'male' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                                    مرد
                                                                </label>
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][gender]" value="female" {{ $employer->gender == 'female' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                                    زن
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="radio-inline" id="paid_status">
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][paid_status]" value="employedWithSalary" {{ $employer->paid_status == 'employedWithSalary' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                                    شاغل مزد بگیر
                                                                </label>
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][paid_status]" value="familyWithoutSalary" {{ $employer->paid_status == 'familyWithoutSalary' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                    ...
                                                    <div class="col-lg-4 col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="radio-inline" id="is_insured">
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][is_insured]" value="yes" {{ $employer->is_insured == '1' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                                    دارد
                                                                </label>
                                                                <label class="radio radio-outline radio-primary mr-0 ml-4">
                                                                    <input type="radio" name="employers[{{ $employer->id }}][is_insured]" value="no" {{ $employer->is_insured == '0' ? 'checked="checked"' : '' }}/>
                                                                    <span class="mr-0 ml-2"></span>
                                                                    ندارد
                                                                </label>
                                                            </div>
...
{{--                                        </div>--}}
                                ...
                                <button class="btn btn-primary mt-4" type="button" onclick="addEmployer()">اضافه کردن</button>
                            </div>
                        </div>
                    </div>

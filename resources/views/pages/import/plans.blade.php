...
@section('dashboard_page_title', 'ایمپورت اکسل طرح ها')
    ...
    <div class="container-fluid">
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="tab-content m-0 mt-4 p-0">
                    <div class="tab-pane active" id="tab_forms_widget_1" role="tabpanel">
                        <form action="{{ route('import.plans') }}" class="dropzone text-center" id="my-great-dropzone">
                            @csrf
                            <img src="{{ asset('/assets/img/svg/excel.svg') }}" alt="" class="dz-image mt-8 mx-auto" data-dz-imgage width="48">
                            <div class="dz-message mb-0" data-dz-message><span>فایل اکسل <u><strong>طرح ها</strong></u> را اینجا بکشید و رها کنید</span></div>
                        </form>
                    </div>
                </div>
                <!--end::Nav Content-->
            ...
            <div class="card-footer text-right">
                <a id="duplicatedPlans" href="{{ route('export.duplicates') }}" class="btn btn-primary d-none" target="_blank">دانلود اکسل کاربران تکراری</a>
                <a id="errorsPlans" href="{{ route('export.errors') }}" class="btn btn-primary d-none" target="_blank">دانلود اکسل کاربران ثبت نشده</a>
            </div>
        </div>
    </div>
@endsection
...
@push('dashboard_extra_js')
    ...
    <script>
        Dropzone.options.myGreatDropzone = {
            ...
            dictUploadCanceled: "آپلود فایل لغو شد",
